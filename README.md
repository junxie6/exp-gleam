...
$ gleam master --address="192.168.6.20:45326" --logDirectory="/home/jun/tmp/exp-gleam"
...
$ GRPC_GO_REQUIRE_HANDSHAKE=off go run -v -mod vendor main.go -distributed -f data.txt
```
